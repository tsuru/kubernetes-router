...
func TestGetWebService(t *testing.T) {
	...
	webService, err := svc.getWebService("test", router.RoutesRequestExtraData{}, nil)
	...
	webService, err = svc.getWebService("namespacedApp", router.RoutesRequestExtraData{}, nil)
	if err != nil {
		t.Errorf("Expected err to be nil. Got %v.", err)
	}
